...
window.popupS = __webpack_require__(/*! popups */ "./node_modules/popups/dist/popupS.js");
...
var APP_KEY = "";
var APP_CLUSTER = "mt1";
var pusher = new pusher_js__WEBPACK_IMPORTED_MODULE_1___default.a(APP_KEY, {
  cluster: APP_CLUSTER,
...
Echo.channel('lara_hello').listen('SomethingHappens', function (e) {
  alert(e.whatHappens);
});
Echo["private"]('App.Models.User.' + userId).notification(function (notification) {
  alert(notification.type + ': ' + notification.subject);
});
Echo["private"]('update.post.report').listen('.post.updated', function (e) {
  popupS.alert({
    title: 'Измененная статья: ' + e.title,
    content: e.message
  });
});
Echo["private"]('total.admin.report').listen('.create.admin.report', function (e) {
  popupS.alert({
    title: 'Отчёт',
    content: e.report
  });
...
__webpack_require__(/*! /Users/excent63/Sites/lara3skill/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/excent63/Sites/lara3skill/resources/sass/app.scss */"./resources/sass/app.scss");
